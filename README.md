...
2. [Understanding the web basics](./workshops/2_understanding_the_web_basics)
3. [Introduction to Django](./workshops/3_introduction_to_django)
4. [Introduction to git](./workshops/4_introduction_to_git)
5. [Python basics variables functions files for beginners](./workshops/5_python_basics_variables_functions_files_for_beginners)
6. [Data visualization with django and highcharts](./workshops/6_data_visualization_with_django_and_highcharts)
7. [Workshop web scraping](./workshops/7_workshop_web_scraping)
8. [Python in science](./workshops/8_python_in_science)
9. [Test driven development](./workshops/9_test_driven_development)
10. [Pandas intro](./workshops/10_pandas_intro)
11. [Building a small web app using mvc patterns](./workshops/11_building_a_small_web_app_using_mvc_patterns)
12. [How to write pythonic code](./workshops/12_how_to_write_pythonic_code)
13. [Fun games](./workshops/13_fun_games)
14. [Coding alg to win](./workshops/14_coding_alg_to_win)
15. [Microservices](./workshops/15_microservices)
16. [Rest apis](./workshops/16_rest_apis)
17. [Blender solar system modellingn](./workshops/17_blender_solar_system_modelling)
18. [Git and github](./workshops/18_git_and_github)
19. [Telegram Bots](./workshops/19_Telegram_Bots)
20. [Python beginners workshop](./workshops/20_python_beginners_workshop)
21. [MicroPython IoT workshop](./workshops/21_Micro_Python_IoT_Workshop)
22. [Hardware Hackevening Resources](./workshops/22_Hardware_hack_evening)
23. [Data Wrangling with Pandas](./workshops/23_Data_Wrangling_Pandas) ([Meetup event](https://www.meetup.com/PyLadies-Berlin/events/262358177/))
