...
A. Let's use a dictionary to describe each room. Set a variable called door_greetings and is a dictionary
with keys the door number and values the door greeting. eg. door_greetings = {'1': "Welcome to the paradise"}
